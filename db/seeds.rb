...
Message.create(from_user:1,to_user:2,body:'Hey Willem!',message_type:'chat',read:0);
Message.create(from_user:1,to_user:2,body:'Alles goed?!',message_type:'chat',read:0);
Message.create(from_user:2,to_user:1,body:'Hey Pascal',message_type:'chat',read:0);
Message.create(from_user:2,to_user:1,body:'Jazeker, met jou?',message_type:'chat',read:0);
Message.create(from_user:2,to_user:1,body:'Ook wel.!',message_type:'chat',read:0);


Offer.create(title:'Aanbieding 1',user_id:4,message:'Ik heb iets te bieden', latitude:'51.977743', longitude:'5.970249', fulfilled: 0)